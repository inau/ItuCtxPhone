...
public class LocationChangeActivity extends FragmentActivity implements LocationListener {
    ...
    String mMinor;
    String room;
    boolean isFoundClosestBeacon = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Integer.parseInt(mMajor) > 0 && Integer.parseInt(mMajor) <= 5){//Check major
            ...
            isFoundClosestBeacon = true;
        }else{
            isFoundClosestBeacon = false;
        }
    ...
    public void onLocationChanged(Location location) {
        ...
        if(isFoundClosestBeacon){//found closest beacon
            googleMap.addMarker(new MarkerOptions()
                    .position(new LatLng(mClosestLongitude, mClosestLatitude))
                    .title(mMajor + room));
        }else{//not found - get GPS
            googleMap.addMarker(new MarkerOptions()
